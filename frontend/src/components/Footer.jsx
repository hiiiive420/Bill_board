    ...
    <footer className="relative overflow-hidden bg-white font-sans">
      <div className="relative min-h-[680px] sm:min-h-[730px] lg:min-h-[900px]">
        ...
        <div className="absolute inset-x-0 top-4 z-20 flex flex-col items-center px-6 text-center sm:top-4 lg:top-8">
          <h2 className="mb-3 text-[clamp(1.55rem,6vw,2.15rem)] font-black leading-[1.05] text-[#184074] sm:mb-4 sm:text-[clamp(2rem,7vw,5.125rem)] lg:mb-5">
            Ready To Be Seen?
          </h2>

          <button
            type="button"
            onClick={() => goTo("/services/billboards#billboards")}
            className="rounded-full bg-gradient-to-b from-[#2a5298] to-[#1a3a6e] px-6 py-2.5 text-sm font-bold text-white shadow-[0_4px_18px_rgba(24,64,116,.38)] transition hover:-translate-y-0.5 hover:shadow-[0_8px_28px_rgba(24,64,116,.5)] sm:px-12 sm:py-3 sm:text-[clamp(.9rem,1.5vw,1.25rem)]"
          >
            Book a Billboard
          </button>
        </div>
          ...
          <div className="pointer-events-auto mx-auto flex min-h-[440px] max-w-[1328px] items-center justify-center overflow-hidden rounded-[46px] border-[6px] border-white bg-[#205DAD] px-5 py-7 text-center sm:h-[clamp(500px,40vw,590px)] sm:min-h-0 sm:rounded-[clamp(72px,12vw,174px)] sm:px-10 sm:py-8">
            <div className="flex w-full max-w-[820px] flex-col items-center">
              <button
                type="button"
                onClick={() => goTo("/")}
                className="font-black leading-none text-white transition hover:text-[#9ED8F7]"
                style={{
                  fontFamily: "'Arial Rounded MT Bold', sans-serif",
                  fontSize: "clamp(3.75rem, 8vw, 6.8rem)",
                  fontWeight: 900,
                }}
              >
                SIGN <span className="text-[#9ED8F7]">ART</span>
              </button>
              ...
              <nav className="mt-5 flex flex-wrap items-center justify-center gap-x-5 gap-y-3 text-[clamp(.85rem,2.6vw,1.25rem)] font-black text-white sm:mt-8 sm:gap-x-8 lg:gap-x-10">
                <button type="button" onClick={() => goTo("/")} className="hover:text-[#9ED8F7]">
                  Home
                </button>
                <button
                  type="button"
                ...
                <a href="tel:+94775788907" className="hover:text-[#9ED8F7]">
                  Call Us
                </a>
                <button
                  type="button"
              ...
              <p className="mt-5 max-w-[720px] text-[clamp(1rem,2.5vw,1.38rem)] font-normal leading-[1.45] text-white sm:mt-8">
        ...
        <div className="absolute inset-x-0 bottom-0 z-20 px-6 pb-4 text-center sm:bottom-4 sm:pb-0 lg:bottom-3">
