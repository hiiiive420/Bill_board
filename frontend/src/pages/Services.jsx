  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-[#184074]">
      ...
      <main>
        ...
        <div className="mx-auto mt-8 flex max-w-[360px] flex-wrap justify-center gap-2 px-4 sm:max-w-none sm:gap-3 lg:justify-center">
                {serviceEntries.map(([itemSlug, service]) => {
                  ...
                  return (
                    <Link
                      ...
                      className={[
                        "rounded-full px-3 py-2 text-[12px] font-black transition sm:px-5 sm:py-3 sm:text-sm",
                        isActive
